...
window.addEventListener("load",()=>{
    ...
    var cantidadPreguntas = 44;//Para establecer el final del recorrido de las preguntas.
    ...
    var todasLasPreguntas = [pregunta1,pregunta2,pregunta3,pregunta4,pregunta5,pregunta6,pregunta7,pregunta8,pregunta9,pregunta10,
        ...
        pregunta41,pregunta42,pregunta43,pregunta44
    ];
    ...
    var todasLasRespuestas = [0,3,3,0,0,1,0,2,0,1,
                              3,0,2,1,0,1,0,1,1,0,
                              1,0,3,0,3,1,0,1,1,2,
                              0,3,1,0,1,0,0,1,1,1,
                              2,2,3,0]; 
